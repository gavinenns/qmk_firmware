...
[_SUPER] = LAYOUT_planck_grid(
  ...
  CMD_TAB,  _______,  _______,  _______, S_(KC_F), _______, S_(KC_H), S_(KC_J), S_(KC_K),     S_(KC_L),    _______, _______,
...
[_GAME] = LAYOUT_planck_grid(
  ...
  KC_LCTL, _______, _______, _______,  KC_SPC,  KC_SPC, GM_RAIS, GM_RAIS, G_EXIT,   _______, _______, _______
),
